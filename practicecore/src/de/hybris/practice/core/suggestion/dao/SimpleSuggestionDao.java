 ...
 */
package de.hybris.practice.core.suggestion.dao;
 ...
 * {@link de.hybris.practice.core.suggestion.SimpleSuggestionService}.
 */
public interface SimpleSuggestionDao extends Dao
{
	...
	List<ProductModel> getProducts(int price, String currency);
}
