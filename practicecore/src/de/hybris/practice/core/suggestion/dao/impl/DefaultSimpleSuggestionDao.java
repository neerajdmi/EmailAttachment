 ...
 */
package de.hybris.practice.core.suggestion.dao.impl;
...
import de.hybris.practice.core.suggestion.dao.SimpleSuggestionDao;
...
public class DefaultSimpleSuggestionDao extends AbstractItemDao implements SimpleSuggestionDao
{
	...
	@Override
	public List<ProductModel> getProducts(final int price, final String currency)
	{

		final StringBuilder query = new StringBuilder(
				"select {p.pk} from {product as p}, {pricerow as pr},{Currency as c}  where {p.code}={pr.productid} and {pr.price} >= ?price and {pr.currency} ={c.pk} and {c.isocode}= ?currency ");
		final Map<String, Object> params = new HashMap<String, Object>();
